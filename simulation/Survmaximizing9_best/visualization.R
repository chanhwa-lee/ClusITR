...
ggplot(policy_value_plot_data, 
  ...
  scale_fill_manual(values = c("NoIntIPW" = "darkgreen", 
                               ...
                               "addIPW" = "red", 
                               "Oracle" = "purple")) +
  labs(title = "Surv Value Maximization",
       x = "Sample Size", y = "Policy Value") +
  facet_wrap(~Scenario)


ggsave("Surv_value_Maximization_Scenarios.jpeg", width = 12, height = 6)
...
ggsave("Beta_Bias_Plot_Surv_Maximization.jpeg", width = 12, height = 6)
